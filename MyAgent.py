...
class Brain:
	...
	def save(self, steps):
		self.model.save("test_model_"+str(steps))
...
# =======================================================================
	def Save(self):
		self.brain.save(self.steps)
		return self.ExpReplay.samples

	def Load(self, exp_replay, steps):
		self.brain.model = load_model("test_model_"+str(steps))
		self.ExpReplay = exp_replay